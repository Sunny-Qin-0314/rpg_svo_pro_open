...
class FrameHandlerMonoEvent : public FrameHandlerBase
{
public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  typedef std::shared_ptr<FrameHandlerMonoEvent> Ptr;

  /// Default constructor
  FrameHandlerMonoEvent(
  ...
  virtual ~FrameHandlerMonoEvent() = default;
